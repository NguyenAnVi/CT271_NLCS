                ...
                <div class="uk-cover-container">
                    ...
                    <form id="register-form" 
                        ...
                        <label for="saleoff_start">
                            Thời điểm bắt đầu: 
                            <input tabindex="1" type="datetime-local" name="saleoff_start" 
                                class="uk-input uk-width-1-1 uk-form-large @error('password_confirmation') uk-form-danger @enderror" 
                        ...
                        <label for="saleoff_end">
                            Thời điểm kết thúc:
                            <input tabindex="1" type="datetime-local" name="saleoff_end" 
                                class="uk-input uk-width-1-1 uk-form-large @error('password_confirmation') uk-form-danger @enderror" 
